        ...
        foreach ($children as $child)
        {
            ...
            if ($child->getIsActive())
            {
                ...
                if( in_array($child->getId(),$arr_catsid) ){
                    ...
                    if ($child->getParent()->getName() == "Cor" || $child->getParent()->getName() == "Color" || $child->getParent()->getName() == "Colour") {
                        $html.= '<a class="cor-menu itemMenuName level' . $level . $active . $ClassNoChildren . '" href="' . $this->getCategoryUrl($child) . '"><span class="nav-cor-sample cor-' . strtolower($name) . '"></span></a>';
                    }
                    else {
