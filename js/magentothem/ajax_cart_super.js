...
function showBoxInfo(product_info) {
    ...
    str += "<div class='alert alert-success' role='alert'>"+title_add_to_cart+"</div>";
    str += "<div id ='product_info_box'>"+product_info+"</div>";
    str += "<a href= 'javascript:void(0)'  class='btn btn-default' id ='continue_shopping'>"+title_shopping_continue+"</a>";
    str += "<a href='"+cart_url+"' class='btn btn-default' id ='shopping_cart'>"+title_shopping_cart+"</a></div>";
