...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        $hasNoChildren = ($activeChildrenCount == 0);
        ...
        // $html[] = $htmlLi;
        if ($hasChildren) {
            if ($category->getName() == "Cor" || $category->getName() == "Color" || $category->getName() == "Colour") {
                $html[] = '';
            }
            else {
        ...
        if ($hasNoChildren) {
            if ($category->getParent()->getName() == "Cor" || $category->getParent()->getName() == "Color" || $category->getParent()->getName() == "Colour") {
                $html[] = '<li><a class="cor cor-'.$this->escapeHtml(strtolower($category->getName())).'" href="'.$this->getCategoryUrl($category).'"></a>';
                
            }
            else {
                $html[] = '<li class="no-children"><span class="col-xs-12"><a href="'.$this->getCategoryUrl($category).'"><h2>' . $this->escapeHtml($category->getName()) . '</h2></a></span></li>';
            }
        ...
        if (!empty($htmlChildren)) {
            if ($childrenWrapClass) {
                ...
                // $html[] = '<h2>'.$this->escapeHtml($category->getName()).'</h2>';
            }
            if ($category->getName() == "Cor" || $category->getName() == "Color" || $category->getName() == "Colour") {
                $html[] = '<ul class="cor-wrap">';
                $html[] = $htmlChildren;
                $html[] = '</ul>';
            }
            else {
                $html[] = '<span class="col-xs-10"><h2>'.$this->escapeHtml($category->getName()).'</h2></span><span class="col-xs-2"><i class="fas fa-chevron-right"></i></span><ul class="sub-menu"><li class="back-cell"><span class="col-xs-12"><i class="fas fa-chevron-left"></i><span class="tabs">'.$this->escapeHtml($category->getName()).'</span></span></li>';
                $html[] = $htmlChildren;
                $html[] = '</ul>';
            }
